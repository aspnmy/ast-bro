...
// start invoking the upcoming `ast-bro` name immediately. Execs into the
// sibling `ast-outline` (or falls back to PATH).
fn main() {
    use std::env::args;
    ...
    match res {
        ...
        Err(e) if e.kind() == ErrorKind::NotFound => {
            ...
            eprintln!("");
            eprintln!("This 'ast-bro' is a preview shim shipped with the final ast-outline 2.1.1 release.");
