...
CLI installer for [ast-outline](https://github.com/aeroxy/ast-outline) — a fast, AST-based code-navigation toolkit for source files. Downloads the pre-built Rust binary on install.
...
- [PyPI package](https://pypi.org/project/ast-outline-cli/) (Python installer)
